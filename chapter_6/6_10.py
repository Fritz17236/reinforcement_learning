...
class GridWorld:
    ...
    def step(self, action):
        ...
        # stochastic displacement due to wind
        wind_displacement = self.col_wind_speeds[self.location[0]]
        next_y += np.random.choice([wind_displacement-1, wind_displacement, wind_displacement + 1])
